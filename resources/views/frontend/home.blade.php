...
@section('content')
    ...
    {{-- Start slide show --}}
    <div class="col-md-12">
        <div id="carouselExampleDark" class=" carousel-dark slide" data-bs-interval="1200" data-bs-ride="carousel"
                ...
                <div
                    ...
                    <a href="https://www.interior.gov.kh/request/doc/url?path=2023/08/24/1692880609.pdf" target="_blank">
                        <div class="card mb-3" style="max-width: 600px;" style="padding-top: 20px; margin-bottom: 30px;">
                            <div class="row g-0">
                                <div class="col-md-4" style="padding: 10px 0px 10px 10px; ">
                                    <img src="../images/Book/4.YS_5.jpg" class="img-fluid rounded-start" alt="...">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
