<footer class=" text-white pt-5 pb-4" style="background:#2d86ea; margin-top:30px;">
    <div class="container text-center text-md-left">
        <div class="row text-center text-md-left">

            <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
                <a class="navbar-brand  " href="{{ url('/') }}">
                    <img  src="{{ url('/images/white_Sakkal.png')}}" alt="Cover Image" width="80px" height="80px">
                    </a>
                <p style="margin-top: 20px; font-size:18px"> &#xA9; រក្សាសិទ្ធគ្រប់យ៉ាងដោយ <b style="font-size: 20px">សាកល</b> ឆ្នាំ២០២២ គោលការណ៍ឯកភាព | Private Policy</p>
            </div>
